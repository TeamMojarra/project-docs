...
Usaremos un tablero tipo Kanban para que todas las tareas estén visibles y actualizadas. Cada tarea debe tener una descripción clara, una persona responsable y un criterio mínimo de “listo” (Definition of Done). Procuraremos no trabajar en demasiadas cosas al mismo tiempo; por eso mantendremos pocas tareas “In Progress” por persona y moveremos el estado de las tareas conforme avancemos, para que el tableru refleje la realidad.

*Comunicación y reuniones*  
Tendremos una reunión corta semanal para revisar progreso, prioridades y bloqueos. Si alguien no puede asistir, dejará un estado por mensaje (qué hizo, qué hará y si está bloqueado). Además, si alguien se queda atascado por má de 30–60 minutos, lo comunicará de inmediato para pedir ayuda y no perder tiempo.
